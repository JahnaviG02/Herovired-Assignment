...
public class InventoryManagementClass{
  ...
  static Product[] products = {
    new Product("Bike", 75000, 3),
    new Product("Car", 500000, 5),
    new Product("Headphones", 7000, 10),
    new Product("Cycle", 3000, 15),
    new Product("TV", 10000, 20)
  };
  ...
  private static void updateInventory() {
    ...
    if (index == -1) {
      ...
      System.out.print("Enter quantity to add or delete: ");
